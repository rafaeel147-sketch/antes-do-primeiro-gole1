...
Public timestamp evidence includes the pre-existing CEPV landing page commit from **2026-08-20** (`6ede5d4ebcf7d3622649703f0b7b3682fa04b796`) and the provenance issue #9.

## New work created after the Challenge started

The `webmcp/` directory is new Challenge-period work. It adds a browser-agent interface without replacing the original engine.
